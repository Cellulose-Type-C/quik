...
import dev.cellulose.sendsans.model.ScheduledMessage
...
class Navigator @Inject constructor(
    ...
    /**
     * @param source String to indicate where this SendSans+ screen was launched from. This should be
    ...
    fun showDeveloper() {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/sendsans-sms/sendsans/graphs/contributors"))
        startActivityExternal(intent)
    }

    fun showSourceCode() {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/sendsans-sms/sendsans"))
        startActivityExternal(intent)
    }

    fun showChangelog() {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/sendsans-sms/sendsans/releases"))
        startActivityExternal(intent)
    }

    fun showLicense() {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/sendsans-sms/sendsans/blob/master/LICENSE"))
        startActivityExternal(intent)
    }
    ...
    fun showRating() {
        ...
        try {
            ...
            val url = "https://github.com/sendsans-sms/sendsans"
    ...
    fun showSupport() {
        ...
        intent.putExtra(Intent.EXTRA_EMAIL, arrayOf("sendsans@octo.sh"))
        intent.putExtra(Intent.EXTRA_SUBJECT, "SendSans Support")
    ...
    fun showInvite() {
        Intent(Intent.ACTION_SEND)
                .setType("text/plain")
                .putExtra(Intent.EXTRA_TEXT, "https://github.com/sendsans-sms/sendsans/releases/latest")
