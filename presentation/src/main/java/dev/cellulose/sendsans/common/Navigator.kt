...
class Navigator @Inject constructor(
    ...
    fun showDeveloper() {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/Cellulose-Type-C/Sendsans/graphs/contributors"))
        startActivityExternal(intent)
    }

    fun showSourceCode() {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/Cellulose-Type-C/Sendsans"))
        startActivityExternal(intent)
    }

    fun showChangelog() {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/Cellulose-Type-C/Sendsans/releases"))
        startActivityExternal(intent)
    }
    ...
    fun showRating() {
        ...
        try {
            ...
            val url = "https://github.com/Cellulose-Type-C/Sendsans"
    ...
    fun showSupport() {
        ...
        intent.putExtra(Intent.EXTRA_EMAIL, arrayOf("SendSans@protonmail.com"))
    ...
    fun showInvite() {
        Intent(Intent.ACTION_SEND)
                .setType("text/plain")
                .putExtra(Intent.EXTRA_TEXT, "https://github.com/Cellulose-Type-C/Sendsans/releases/latest")
