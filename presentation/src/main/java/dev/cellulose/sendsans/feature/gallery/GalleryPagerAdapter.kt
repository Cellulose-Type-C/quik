...
import dev.cellulose.sendsans.databinding.GalleryImagePageBinding
import dev.cellulose.sendsans.databinding.GalleryVideoPageBinding
    ...
    override fun onBindViewHolder(holder: QkViewHolder, position: Int) {
        ...
        when (getItemViewType(position)) {
            ...
            VIEW_TYPE_VIDEO -> {
                ...
                val dataSourceFactory = DefaultDataSourceFactory(context, Util.getUserAgent(context, "SendSans"))
