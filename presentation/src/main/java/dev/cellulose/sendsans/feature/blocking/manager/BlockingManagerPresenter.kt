package dev.cellulose.sendsans.feature.blocking.manager
...
import dev.cellulose.sendsans.blocking.CallBlockerBlockingClient
import dev.cellulose.sendsans.blocking.CallControlBlockingClient
import dev.cellulose.sendsans.blocking.QksmsBlockingClient
import dev.cellulose.sendsans.blocking.ShouldIAnswerBlockingClient
...
class BlockingManagerPresenter @Inject constructor(
    ...
    override fun bindIntents(view: BlockingManagerView) {
        ...
        view.qksmsClicked()
                ...
                .autoDisposable(view.scope())
                .subscribe {
                    prefs.blockingManager.set(Preferences.BLOCKING_MANAGER_SendSans)
                }
