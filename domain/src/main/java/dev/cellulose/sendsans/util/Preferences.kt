 ...
 */
package dev.cellulose.sendsans.util
...
class Preferences @Inject constructor(
    ...
    companion object {
        ...
        const val BLOCKING_MANAGER_SendSans = 0
    ...
    val blockingManager = rxPrefs.getInteger("blockingManager", BLOCKING_MANAGER_SendSans)
    ...
    val fingerprintLock = rxPrefs.getBoolean("fingerprintLock", false)
