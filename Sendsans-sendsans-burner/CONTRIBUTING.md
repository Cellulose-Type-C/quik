...
## Update the Wiki 
To update the wiki, simply navigate to the [wiki tab](https://github.com/Cellulose-Type-C/Sendsans/wiki) in this repository, find the file that you want to edit, and click `Edit Page`. Edit and commit your change. For more sizable changes, or feedback and questions, please comment in [this discussion](https://github.com/Cellulose-Type-C/Sendsans/discussions/174).
...
Feel free to use [deepwiki LLM](https://deepwiki.com/sendsans-burner/sendsans) to understand the code structure before contributing and explore the implementation interactively.
...
If you are stuck on something specific open up that draft PR, or hop on over to [matrix](https://matrix.to/#/#sendsans-burner:matrix.org) for suggestions.
